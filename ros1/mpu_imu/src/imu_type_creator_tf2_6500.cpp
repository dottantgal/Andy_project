...
public:
    SubNanoAndPubImu()
    {
        ...
        pub_imu_ = n_.advertise<sensor_msgs::Imu>("/imu/6500", 1);

        sub_nano_ = n_.subscribe("/imu/data_raw_6500", 1, &SubNanoAndPubImu::callback, this);
    }
    ...
    void callback(const std_msgs::Float32MultiArray::ConstPtr& array)
    {
        ...
        imu_msg_.header.frame_id = "imu_6500";
        ...
        transform_.child_frame_id = "imu_6500";
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "imu_type_creator_tf2_6500");
